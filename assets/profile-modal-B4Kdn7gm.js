import{T as d,g as c,a as g}from"./gamification-B0sDzXF-.js";import{ACHIEVEMENTS as u,BADGES as b}from"./gamification-registry-DzpjLHof.js";function M(e){const t=v(),r=x();setTimeout(()=>{r.classList.remove("scale-95","opacity-0"),r.classList.add("scale-100","opacity-100")},10);const a=m(e);r.innerHTML=`
        ${f(a)}
