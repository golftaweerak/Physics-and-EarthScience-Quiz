import{M as K}from"./modal-handler-CjwIEypi.js";import{getQuizzesList as O,getQuizProgress as P,categoryDetails as A}from"./data-manager-CsB4yJx8.js";import{g as R,a as W}from"./custom-quiz-handler-DW6FlqYA.js";function L(r,T,p,h="./"){const d=r.amount||r.questions?.length||0;if(d===0)return"";const u=r.storageKey||`quizState-${r.id||r.customId}`,m=r.id||r.customId,o=T(m),y=(r.icon||"./assets/icons/dices.png").replace(/^\.\//,h),B=r.altText||"ไอคอนแบบทดสอบ",a=P(u,d);let f="",l="",g="",w="font-medium",x="";return a.isFinished?f=`
