...
export const EARTH_SCIENCE_BASIC_SYLLABUS = Object.freeze({
  ...
  units: [{
    id: 1,
    title: "เอกภพ",
    standard: "ว 3.1 เข้าใจองค์ประกอบ ลักษณะ กระบวนการเกิด และวิวัฒนาการของเอกภพ กาแล็กซี ดาวฤกษ์ และระบบสุริยะ รวมทั้งปฏิสัมพันธ์ภายในระบบสุริยะที่ส่งผลต่อสิ่งมีชีวิต และการประยุกต์ใช้เทคโนโลยีอวกาศ",
    totalUnitHours: 22,
    chapters: [{
      chapterId: 1,
      title: "เอกภพและกาแล็กซี",
      shortTitle: "เอกภพฯ",
      learningOutcomes: ["ว 3.1 ม.6/1 อธิบายการกำเนิดและการเปลี่ยนแปลงพลังงาน สสาร ขนาด อุณหภูมิของเอกภพหลังเกิดบิกแบง", "ว 3.1 ม.6/2 อธิบายหลักฐานที่สนับสนุนทฤษฎีบิกแบง", "ว 3.1 ม.6/3 อธิบายโครงสร้างและองค์ประกอบของกาแล็กซีทางช้างเผือก และระบุตำแหน่งของระบบสุริยะ",],
      specificTopics: ["ทฤษฎีบิกแบงและวิวัฒนาการของเอกภพ", "หลักฐานสนับสนุนทฤษฎีบิกแบง: การขยายตัวของเอกภพ และไมโครเวฟพื้นหลัง", "กาแล็กซีทางช้างเผือก โครงสร้าง และตำแหน่งของระบบสุริยะ",],
      keywords: ['เอกภพ', 'กาแล็กซี', 'บิกแบง', 'ทางช้างเผือก', 'universe', 'galaxy', 'big bang'],
      hours: 5,
    }, {
      chapterId: 2,
      title: "ดาวฤกษ์",
      shortTitle: "ดาวฤกษ์",
      learningOutcomes: ["ว 3.1 ม.6/4 อธิบายกระบวนการเกิดดาวฤกษ์", "ว 3.1 ม.6/5 ระบุปัจจัยที่ส่งผลต่อความส่องสว่างของดาวฤกษ์ และอธิบายความสัมพันธ์ระหว่างความส่องสว่างกับโชติมาตร", "ว 3.1 ม.6/6 อธิบายความสัมพันธ์ระหว่างสี อุณหภูมิผิว และสเปกตรัมของดาวฤกษ์", "ว 3.1 ม.6/7 อธิบายลำดับวิวัฒนาการที่สัมพันธ์กับมวลตั้งต้นของดาวฤกษ์",],
      specificTopics: ["กระบวนการกำเนิดดาวฤกษ์ สมดุลอุทกสถิต และปฏิกิริยาเทอร์มอนิวเคลียร์", "สมบัติดาวฤกษ์: ความส่องสว่าง, โชติมาตร, สี, อุณหภูมิผิว และสเปกตรัม", "วิวัฒนาการและจุดจบของดาวฤกษ์ที่สัมพันธ์กับมวลตั้งต้น",],
      keywords: ['ดาวฤกษ์', 'ความส่องสว่าง', 'โชติมาตร', 'สเปกตรัม', 'H-R', 'star', 'stellar'],
      hours: 7,
    }, {
      chapterId: 3,
      title: "ระบบสุริยะ",
      shortTitle: "ระบบสุริยะ",
      learningOutcomes: ["ว 3.1 ม.6/8 อธิบายกระบวนการเกิดระบบสุริยะ และลักษณะของดาวเคราะห์ที่เอื้อต่อการดำรงชีวิต", "ว 3.1 ม.6/9 อธิบายโครงสร้างของดวงอาทิตย์ การเกิดลมสุริยะ พายุสุริยะ และผลที่มีต่อโลก",],
      specificTopics: ["กระบวนการเกิดระบบสุริยะ การแบ่งเขตบริวาร และเขตที่เอื้อต่อการมีสิ่งมีชีวิต", "โครงสร้างและปรากฏการณ์บนดวงอาทิตย์",],
      keywords: ['ระบบสุริยะ', 'ดวงอาทิตย์', 'ดาวเคราะห์', 'solar system', 'sun', 'planet'],
      hours: 6,
    }, {
      chapterId: 4,
      title: "เทคโนโลยีอวกาศ",
      shortTitle: "เทคโนฯ",
      learningOutcomes: ["ว 3.1 ม.6/10 สืบค้นข้อมูล อธิบายการสำรวจอวกาศ และนำเสนอแนวคิดการนำความรู้มาประยุกต์ใช้",],
      specificTopics: ["เทคโนโลยีอวกาศและการประยุกต์ใช้: กล้องโทรทรรศน์, ยานอวกาศ, ดาวเทียม",],
      keywords: ['เทคโนโลยีอวกาศ', 'กล้องโทรทรรศน์', 'ดาวเทียม', 'ยานอวกาศ', 'space technology', 'satellite', 'telescope'],
      hours: 4,
    },],
  }, {
    id: 2,
    title: "กระบวนการเปลี่ยนแปลงภายในโลก",
    standard: "ว 3.2 เข้าใจองค์ประกอบและความสัมพันธ์ของระบบโลก กระบวนการเปลี่ยนแปลงภายในโลกและบนผิวโลก ธรณีพิบัติภัย กระบวนการเปลี่ยนแปลงลมฟ้าอากาศและภูมิอากาศโลก รวมทั้งผลต่อสิ่งมีชีวิตและสิ่งแวดล้อม",
    totalUnitHours: 22,
    chapters: [{
      chapterId: 5,
      title: "โครงสร้างโลก",
      shortTitle: "โครงสร้างโลก",
      learningOutcomes: ["ว 3.2 ม.6/1 อธิบายการแบ่งชั้นและสมบัติของโครงสร้างโลก",],
      specificTopics: ["การแบ่งชั้นโครงสร้างโลกตามองค์ประกอบทางเคมีและสมบัติเชิงกล",],
      keywords: ['โครงสร้างโลก', 'เปลือกโลก', 'เนื้อโลก', 'แก่นโลก', 'structure of earth'],
      hours: 7,
    }, {
      chapterId: 6,
      title: "การแปรสัณฐานของแผ่นธรณี",
      shortTitle: "แปรสัณฐาน",
      learningOutcomes: ["ว 3.2 ม.6/2 อธิบายหลักฐานทางธรณีวิทยาที่สนับสนุนการเคลื่อนที่ของแผ่นธรณี", "ว 3.2 ม.6/3 ระบุสาเหตุ และอธิบายรูปแบบแนวรอยต่อของแผ่นธรณีที่สัมพันธ์กับการเคลื่อนที่",],
      specificTopics: ["หลักฐานสนับสนุนการเคลื่อนที่ของแผ่นธรณี: ทฤษฎีทวีปเลื่อน และทฤษฎีการแผ่ขยายพื้นสมุทร", "ทฤษฎีธรณีแปรสัณฐาน และรูปแบบแนวรอยต่อของแผ่นธรณี",],
      keywords: ['แปรสัณฐาน', 'แผ่นธรณี', 'ทวีปเลื่อน', 'plate tectonics', 'tectonic'],
      hours: 8,
    }, {
      chapterId: 7,
      title: "ธรณีพิบัติภัย",
      shortTitle: "พิบัติภัย",
      learningOutcomes: ["ว 3.2 ม.6/4 อธิบายสาเหตุ กระบวนการเกิดภูเขาไฟระเบิด และแนวทางการเฝ้าระวัง", "ว 3.2 ม.6/5 อธิบายสาเหตุ กระบวนการเกิดแผ่นดินไหว และแนวทางการเฝ้าระวัง", "ว 3.2 ม.6/6 อธิบายสาเหตุ กระบวนการเกิดสึนามิ และแนวทางการเฝ้าระวัง",],
      specificTopics: ["ภูเขาไฟระเบิด: สาเหตุ, กระบวนการเกิด, พื้นที่เสี่ยงภัย และการปฏิบัติตน", "แผ่นดินไหว: สาเหตุ, กระบวนการเกิด, พื้นที่เสี่ยงภัย และการปฏิบัติตน", "สึนามิ: สาเหตุ, กระบวนการเกิด, พื้นที่เสี่ยงภัย และการปฏิบัติตน",],
      keywords: ['ธรณีพิบัติภัย', 'แผ่นดินไหว', 'สึนามิ', 'ภูเขาไฟ', 'disaster', 'earthquake', 'tsunami', 'volcano'],
      hours: 7,
    },],
  }, {
    id: 3,
    ...
    chapters: [{
      ...
      learningOutcomes: ["ว 3.2 ม.6/7 อธิบายปัจจัยสำคัญที่มีผลต่อการได้รับพลังงานจากดวงอาทิตย์", "ว 3.2 ม.6/8 อธิบายการหมุนเวียนของอากาศที่เป็นผลมาจากความแตกต่างของความกดอากาศ", "ว 3.2 ม.6/9 อธิบายทิศทางการเคลื่อนที่ของอากาศที่เป็นผลมาจากการหมุนรอบตัวของโลก", "ว 3.2 ม.6/10 อธิบายการหมุนเวียนของอากาศตามเขตละติจูดและผลที่มีต่อภูมิอากาศ", "ว 3.2 ม.6/11 อธิบายปัจจัยที่ทำให้เกิดการหมุนเวียนของน้ำผิวหน้าในมหาสมุทร", "ว 3.2 ม.6/12 อธิบายผลของการหมุนเวียนของอากาศและน้ำผิวหน้าในมหาสมุทร",],
      specificTopics: ["สมดุลพลังงานของโลก และปัจจัยที่ส่งผลต่อการรับรังสีดวงอาทิตย์", "การหมุนเวียนของอากาศ: ความกดอากาศ, แรงคอริออลิส, และการหมุนเวียนตามเขตละติจูด", "การหมุนเวียนของน้ำผิวหน้าในมหาสมุทร และผลกระทบ (เอลนีโญ, ลานีญา)",],
      keywords: ['ลมฟ้าอากาศ', 'ภูมิอากาศ', 'บรรยากาศ', 'ความกดอากาศ', 'สมดุลพลังงาน', 'เมฆ', 'พายุ', 'อุตุนิยมวิทยา', 'weather', 'climate', 'meteorology', 'atmospheric'],
      hours: 9,
    }, {
      chapterId: 9,
      title: "การเปลี่ยนแปลงภูมิอากาศ",
      shortTitle: "ภูมิอากาศ",
      learningOutcomes: ["ว 3.2 ม.6/13 อธิบายปัจจัยที่มีผลต่อการเปลี่ยนแปลงภูมิอากาศของโลก",],
      specificTopics: ["การเปลี่ยนแปลงภูมิอากาศโลกและแนวทางปฏิบัติเพื่อลดผลกระทบ",],
      hours: 3,
    }, {
      chapterId: 10,
      title: "ข้อมูลและสารสนเทศทางอุตุนิยมวิทยา",
      shortTitle: "สารสนเทศ",
      learningOutcomes: ["ว 3.2 ม.6/14 แปลความหมายสัญลักษณ์ลมฟ้าอากาศที่สำคัญจากแผนที่อากาศ",],
      specificTopics: ["ข้อมูลและสารสนเทศทางอุตุนิยมวิทยา และการแปลความหมายจากแผนที่อากาศเพื่อวางแผนการดำเนินชีวิต",],
      hours: 4,
    },],
  },],
});
...
export const EARTH_SCIENCE_ADVANCE_SYLLABUS = Object.freeze({
  ...
  chapters: [{
    ...
    title: "ธรณีพิบัติภัย",
    specificTopics: ["ภูเขาไฟระเบิด: สาเหตุ, กระบวนการเกิด, พื้นที่เสี่ยงภัย และการปฏิบัติตน",
