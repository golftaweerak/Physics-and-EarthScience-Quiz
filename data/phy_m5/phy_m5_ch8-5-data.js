...
export const quizItems = [
  ...
  // --- Scenario: Potential Energy vs Displacement ---
  {
    type: "scenario",
  ...
  // --- Scenario: Kinetic Energy vs Time ---
  {
    type: "scenario",
  ...
  // --- Additional Graph Analysis ---
  {
    ...
    options: ["เส้นตรง", "พาราโบลา", "วงรี", "ไฮเพอร์โบลา"],
    answer: "วงรี",
  ...
  },
  {
    ...
    options: ["เส้นตรงขนานกับแกน x", "เส้นตรงผ่านจุดกำเนิด", "พาราโบลาหงาย", "พาราโบลาคว่ำ"],
