export const SiteConfig = {
  ...
  proficiencyGroups: {
    ...
    'Astronomy': {
      ...
      field: 'astronomyXP',
      track: 'earth',
      keywords: ['dara', 'astronomy', 'ดาราศาสตร์', 'เอกภพ', 'กาแล็กซี', 'ดาวฤกษ์', 'ระบบสุริยะ', 'ดาวเคราะห์', 'ทรงกลมฟ้า', 'พิกัด', 'กล้องโทรทรรศน์', 'สเปกตรัม', 'อวกาศ', 'เทคโนโลยีอวกาศ', 'space', 'บิกแบง', 'ทางช้างเผือก', 'ความส่องสว่าง', 'โชติมาตร', 'ดวงอาทิตย์', 'ยานอวกาศ', 'ดาวเทียม', 'สถานีอวกาศ', 'เคพเลอร์', 'สุริยคติ', 'ดาราคติ']
    },
    'Geology': {
      label: 'ธรณีวิทยา',
      field: 'geologyXP',
